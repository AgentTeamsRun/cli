...
const DISPATCH_CASES: Array<{
  ...
  {
    label: 'skl',
    ref: `agentteams_skl_${uuid}`,
    refType: 'skill',
    id: uuid,
    url: `${projectUrl}/skills/${uuid}/download`,
  },
...
describe('agentteams_resolve MCP tool', () => {
  ...
  it('is advertised in the full profile only, and costs 1,762 definition chars', () => {
