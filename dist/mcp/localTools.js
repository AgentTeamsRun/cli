...
const guideGetSpec = {
    ...
    inputSchema: z.strictObject({
        recordKind: z
            ...
            .describe('Record type or workflow whose guide you need. "document", "comment", "co-action", "post-mortem" and "code-review" back MCP write contracts and return a guideHash the write tool compares; the rest are read-only references.'),
    }),
