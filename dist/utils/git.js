...
export function getGitRemoteOriginUrl(execFileSyncImpl = childProcess.execFileSync, cwd) {
 ...
 */
export function hasLinkedGitWorktrees(cwd, execFileSyncImpl = childProcess.execFileSync) {
 ...
 */
export function shouldInstallWorktreeHook(cwd, options, execFileSyncImpl = childProcess.execFileSync) {
