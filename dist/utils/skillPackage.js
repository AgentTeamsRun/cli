 ...
 */
export const detectSkillMirrorTargets = (projectRoot, runnerType) => {
    const required = new Set(runnerType ? (RUNNER_REQUIRED_TARGETS[runnerType] ?? []) : []);
 ...
 */
export const findUnregisteredSkillSlugs = (projectRoot, knownSlugs) => {
