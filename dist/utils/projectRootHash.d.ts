 ...
 */
export declare const normalizeProjectRootPath: (absolutePath: string) => string;
export declare const hashProjectRootPath: (absolutePath: string) => string;
/**
 ...
 */
export declare const resolveProjectRootHash: (startDir?: string) => string | null;
//# sourceMappingURL=projectRootHash.d.ts.map