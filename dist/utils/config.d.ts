...
export declare function globalConfigPath(userHomeDir?: string): string;
/**
 ...
 */
export declare function isDeviceAuthDefaultEnabled(userHomeDir?: string): boolean;
/**
 ...
 */
export declare function setDeviceAuthDefault(enabled: boolean, userHomeDir?: string): string;
