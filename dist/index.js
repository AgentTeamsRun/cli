...
function normalizeInteractiveFormat(format) {
    if (format === undefined || format === null || format === '')
        return 'human';
    if (format === 'json')
        return 'json';
...
program
    ...
    .argument('<action>', 'Action to perform (create, update, download, list, delete, archive, unarchive, revisions, revision-get, revision-restore, comment-list, comment-create, comment-update, comment-delete)')
