...
export declare function listCodeReviewFindings(apiUrl: string, projectId: string, headers: any, codeReviewId: string, params?: Record<string, string | number>): Promise<any>;
...
export declare function cancelCodeReview(apiUrl: string, projectId: string, headers: any, id: string, body?: Record<string, unknown>): Promise<any>;
...
export declare function dismissCodeReviewFinding(apiUrl: string, projectId: string, headers: any, id: string, findingId: string, body?: Record<string, unknown>): Promise<any>;
export declare function resolveCodeReviewFinding(apiUrl: string, projectId: string, headers: any, id: string, findingId: string, body?: Record<string, unknown>): Promise<any>;
export declare function undismissCodeReviewFinding(apiUrl: string, projectId: string, headers: any, id: string, findingId: string, body?: Record<string, unknown>): Promise<any>;
