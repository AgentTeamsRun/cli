...
export const MCP_CLIENTS = [
    ...
    },
    {
        ...
        scopes: {
            user: {
                configPath: (context) => join(context.env.XDG_CONFIG_HOME || join(context.homeDir, '.config'), 'muse', 'settings.json'),
                format: 'json',
            ...
            project: {
                ...
                strategy: 'configOnly',
                requiredRootValues: { schema_version: 1 },
                configOnlyReason: 'Muse Code project-scope MCP settings have not been verified. Register with --scope user instead.',
            },
        },
    },
];
