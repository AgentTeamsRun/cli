...
export declare const MCP_CLIENT_IDS: readonly ["claude-code", "codex", "copilot-cli", "opencode", "amp", "cursor-cli", "kimi-cli", "antigravity", "kiro-cli", "grok-build", "omp", "muse"];
...
export type InstallOutcome = 'INSTALLED' | 'ALREADY_REGISTERED' | 'SKIPPED_CONFIG_ONLY' | 'SKIPPED_NOT_DETECTED'
/**
