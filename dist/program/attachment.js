...
export function registerAttachmentCommand(program) {
    ...
    addJsonResourceLeaf(root, 'attachment', 'list', 'List attachments', (command) => command.option('--trigger-id <id>', 'Daemon trigger ID').option('--document-id <id>', 'Document ID'));
    addJsonResourceLeaf(root, 'attachment', 'create', 'Create an attachment', (command) => command
