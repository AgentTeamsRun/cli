 ...
 */
export function registerCoactionCommand(program) {
    ...
    addLeaf('list', 'List co-actions', (command) => addPaginationOptions(command)
    ...
    addLeaf('takeaway-list', 'List co-action takeaways', (command) => addPaginationOptions(command).option('--id <id>', 'Co-action ID'));
    addLeaf('takeaway-create', 'Create a co-action takeaway', (command) => command
    ...
    addLeaf('takeaway-update', 'Update a co-action takeaway', (command) => command
        .option('--id <id>', 'Co-action ID')
        .option('--takeaway-id <id>', 'Co-action takeaway ID')
        .option('--content <content>', 'Takeaway content')
        .option('--file <path>', 'Read takeaway content from a local file')
        .option('--keep-temp', 'Keep the uploaded file under .agentteams/cli/temp/ instead of deleting it after upload', false));
    addLeaf('takeaway-delete', 'Delete a co-action takeaway', (command) => command.option('--id <id>', 'Co-action ID').option('--takeaway-id <id>', 'Co-action takeaway ID'));
    addLeaf('history', 'List co-action history', (command) => addPaginationOptions(command).option('--id <id>', 'Co-action ID'));
    addLeaf('create', 'Create a co-action', (command) => addWriteContractOptions(command, 'co-action')
        ...
        .option('--status <status>', 'Co-action status (OPEN, CLOSED)')
        .option('--visibility <visibility>', 'Co-action visibility (PRIVATE, PROJECT)'));
    addLeaf('update', 'Update a co-action', (command) => addMutationContractOptions(command, 'co-action', 'co-action')
        .option('--id <id>', 'Co-action ID')
        .option('--title <title>', 'Co-action title')
        .option('--content <content>', 'Co-action content (short text; use --file for long content)')
        .option('--file <path>', 'Read co-action content from a local file')
    ...
    addLeaf('delete', 'Delete a co-action', (command) => addMutationContractOptions(command, 'co-action', 'co-action').option('--id <id>', 'Co-action ID'));
    addLeaf('download', 'Download a co-action', (command) => command.option('--id <id>', 'Co-action ID'));
    addLeaf('cleanup', 'Remove downloaded co-actions', (command) => command.option('--id <id>', 'Co-action ID (omit to remove all downloaded co-actions)'));
    addLeaf('link-plan', 'Link a plan', (command) => command.option('--id <id>', 'Co-action ID').option('--plan-id <id>', 'Plan ID'));
    addLeaf('unlink-plan', 'Unlink a plan', (command) => command.option('--id <id>', 'Co-action ID').option('--plan-id <id>', 'Plan ID'));
    addLeaf('link-completion-report', 'Link a completion report', (command) => command.option('--id <id>', 'Co-action ID').option('--completion-report-id <id>', 'Completion report ID'));
    addLeaf('unlink-completion-report', 'Unlink a completion report', (command) => command.option('--id <id>', 'Co-action ID').option('--completion-report-id <id>', 'Completion report ID'));
    addLeaf('link-post-mortem', 'Link a post-mortem', (command) => command.option('--id <id>', 'Co-action ID').option('--post-mortem-id <id>', 'Post-mortem ID'));
    addLeaf('unlink-post-mortem', 'Unlink a post-mortem', (command) => command.option('--id <id>', 'Co-action ID').option('--post-mortem-id <id>', 'Post-mortem ID'));
}
