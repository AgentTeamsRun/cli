import { CONVENTION_HINT, executeCommand, handleError, normalizeInteractiveFormat, printCommandResult, } from './shared.js';
function readString(value) {
    return typeof value === 'string' && value.length > 0 ? value : undefined;
}
function formatSyncHumanOutput(result) {
