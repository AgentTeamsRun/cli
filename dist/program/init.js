...
export function registerInitCommand(program) {
    program
        ...
        .option('--interactive', 'Choose the agent entry point files from a prompt instead of using the AI clients detected in this folder. Without this flag init asks nothing.', false)
        ...
        .option('--mcp', 'Register AgentTeams with the MCP clients detected in this folder (project scope). Without this flag no client configuration is written.', false)
