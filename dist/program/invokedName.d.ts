 ...
 */
export declare const CANONICAL_CLI_NAME = "agentteams";
/**
 ...
 */
export declare function resolveInvokedName(candidate?: string): string;
//# sourceMappingURL=invokedName.d.ts.map