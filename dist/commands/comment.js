import { createComment, createFindingComment, createReply, createTaskComment, deleteComment, deleteReply, getComment, getReply, listComments, listFindingComments, listReplies, listTaskComments, updateComment, updateReply, } from '../api/comment.js';
...
const mutationContract = (options) => ({
    ...
    switch (action) {
        ...
        case 'create': {
            ...
            if (options.taskId) {
                ...
                return createTaskComment(apiUrl, projectId, headers, options.taskId, { content: options.content, ...writeContract(options) }, options.planId);
            }
            const body = {
                type: options.type,
                content: options.content,
        ...
        case 'reply-get': {
            if (!options.replyId)
                throw new Error('--reply-id is required for comment reply-get');
