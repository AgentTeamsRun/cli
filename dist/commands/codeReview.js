...
import { cancelCodeReview, createCodeReview, createPlanFromCodeReview, deleteCodeReview, dismissCodeReviewFinding, getCodeReview, listCodeReviews, submitCodeReviewResult, undismissCodeReviewFinding, updateCodeReview, } from '../api/codeReview.js';
...
export async function executeCodeReviewCommand(apiUrl, projectId, headers, action, options) {
    switch (action) {
        ...
        case 'show': {
            if (!options.id)
                throw new Error('--id is required for code-review get');
