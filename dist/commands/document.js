...
import { archiveDocument, createDocument, createDocumentComment, deleteDocument, deleteDocumentComment, downloadDocumentBody, getDocument, getDocumentRevision, listDocumentComments, listDocumentRevisions, listDocuments, restoreDocumentRevision, unarchiveDocument, updateDocument, updateDocumentComment, } from '../api/document.js';
    ...
    switch (action) {
        ...
        case 'update': {
            ...
            if (options.tags !== undefined)
                payload.tags = normalizeTags(options.tags);
