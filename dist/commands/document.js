...
const writeContractFields = (options) => {
    const fields = {};
    if (options.guideHash)
 ...
 */
export async function downloadDocumentToFile(apiUrl, projectId, headers, id) {
