import { conventionCreate, conventionDelete, conventionDownload, conventionList, conventionShow, conventionStatus, conventionUpdate, } from './convention.js';
...
async function executeConventionCommandWithContext(action, options) {
    switch (action) {
        case 'list':
 ...
 */
async function executeSyncCommandWithContext(action, options) {
    switch (action) {
        case 'download': {
...
async function forceSkillDownload(cwd) {
