import { cpSync, existsSync, lstatSync, readFileSync, readdirSync, realpathSync, renameSync, rmSync, statSync, symlinkSync, unlinkSync, } from 'node:fs';
...
import { ensureConventionEntryPoints, ensureLocalExclude, isReadableRegularFile, resolveGitCommonDir, toAnchoredExcludePattern, } from '../utils/conventionLink.js';
 ...
 */
export function resolveLinkedWorktreeSource(cwd) {
    let worktreePath;
    try {
...
//# sourceMappingURL=initWorktree.js.map