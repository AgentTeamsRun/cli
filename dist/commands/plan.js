...
import { createPlan, deletePlan, finishPlanLifecycle, getPlan, getPlanDependencies, getPlanStatus, linkOriginIssue, listOriginIssues, listPlans, patchPlanStatus, quickPlan, startPlanLifecycle, unlinkOriginIssue, updatePlan, uploadPlanHtml, } from '../api/plan.js';
...
export async function executePlanCommand(apiUrl, projectId, headers, action, options) {
    ...
    switch (action) {
        ...
        case 'update': {
            ...
            const previewAffecting = typeof body.content === 'string' ||
                typeof body.title === 'string' ||
                typeof body.type === 'string' ||
                typeof body.priority === 'string';
            const updateHasHtmlInput = hasPlanHtmlPreviewInput(options);
            if (previewAffecting && !updateHasHtmlInput) {
                throw new Error('An HTML preview is required when updating the plan body, title, type, or priority. ' +
